...
<html lang="pt-br" data-bs-theme="dark">
  <head>
    ...
    <title>Meus Projetos - Portal</title>
  ...
  <body class="min-vh-100 d-flex flex-column">
    ...
    <main class="container py-4">
      <div class="d-flex align-items-center justify-content-between mb-3">
        <h1 class="h5 mb-0">Meus Projetos</h1>
        <form class="row g-2" method="get">
          <div class="col-auto"><input class="form-control form-control-sm" name="q" value="<?= htmlspecialchars($q) ?>" placeholder="Buscar"></div>
          <div class="col-auto">
          ...
          <div class="col-auto"><button class="btn btn-sm btn-outline-light">Filtrar</button></div>
        </form>
      </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="card glass h-100">
            <div class="card-body">
              ...
              <div class="mt-2"><a class="btn btn-sm btn-outline-light" href="project_view.php?id=<?= (int)$r['id'] ?>"><i class="bi bi-box-arrow-up-right"></i> Ver</a></div>
            </div>
          </div>
        </div>
        <?php endforeach; ?>
        <?php if (!$rows): ?><div class="col-12 text-secondary">Nenhum projeto encontrado.</div><?php endif; ?>
      </div>
    </main>
  </body>
</html>
